...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "PRINT", "IDENT", "INT_LIT", "FLOAT_LIT", "STRING_LIT",
  "$accept", "Program", "StatementList", "Statement", "DeclarationStmt",
  "Block", "IfStmt", "LoopStmt", "PrintStmt", YY_NULLPTR
};
#endif
